    ...
    return (
      <>
        ...
        <div className="w-full justify-between items-stretch h-screen flex flex-shrink-0">
          ...
          <div className={`relative ring-white overflow-y-auto px-4 ${expanded?"w-3/12":"w-1/3"}`}  >
            <div className="z-10 w-full sticky top-0   py-4 flex justify-between items-center gap-4">
              <button onClick={sidebar}>
              <FontAwesomeIcon icon={faBars} className=" w-7 text-2xl ml-3"/>
              </button>
              <Input
          ...
          <div className={`${expanded?"w-7/12":"w-2/3"} border-md-[0.1px] border-secondary`}>
